...
require 'DB.php';
$Std_ID = $_GET['Std_ID'];
$qpro = "select * from member where ID = '$Std_ID' ";
    ...
    <body> 
		...
		<form action = "update_frmstudent.php" method = "post" enctype = "multipart/form-data" id = "form1">
			...
			<table align = center width = 450px border = "0">
				...
				<center>
				<tr><td><label><b> รหัสนักศึกษา: </label></td><td><input name="Std_ID" type="number" id="Std_ID"  value="<?=$rowpro['Std_ID']?>" disabled = ""></td></tr>  
